    ...
    const dictionaries = {
        'zh-CN': {
            strings: {
                ...
                showViewer: '机器人视角',
                hideViewer: '收起视角',
                startingViewer: '正在启动视角…',
                viewerTitle: '{name} 的实时视角',
                openViewerWindow: '新窗口打开',
                viewerFailed: '视角启动失败',
                idle: '空闲',
                acting: '执行中',
                chatting: '聊天中',
        ...
        en: {
            strings: {
                ...
                settings: 'Settings', inventory: 'Inventory', showViewer: 'Bot View', hideViewer: 'Hide View',
                startingViewer: 'Starting view...', viewerTitle: '{name} live view', openViewerWindow: 'Open in new window', viewerFailed: 'View failed',
                idle: 'Idle', acting: 'Acting', chatting: 'Chatting',
